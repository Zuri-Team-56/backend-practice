...
class School(models.Model):
    ...
    faculty_name = models.ForeignKey(FacultyName,  related_name='faculty', on_delete=models.CASCADE, null=True, blank=True)
    ...
    tuition_information = models.ForeignKey(Tuition,  related_name='tuition', on_delete=models.CASCADE, null=True, blank=True)
    financial_aid = models.TextField()
    entry_requirements = models.ForeignKey(EntryRequirement,  related_name='requirement', on_delete=models.CASCADE, null=True, blank=True)
    ...
    school_news = models.ForeignKey(SchoolNews, related_name='school_news', on_delete=models.CASCADE, null=True, blank=True)
